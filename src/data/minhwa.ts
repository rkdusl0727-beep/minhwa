...
export const minhwaList: Minhwa[] = [
  ...
  },
  {
    ...
    differences: fiveDifferences([{x:69,y:34,radius:8},{x:31,y:21,radius:7},{x:27,y:67,radius:8},{x:89,y:12,radius:7},{x:50,y:55,radius:6},{x:44,y:88,radius:7},{x:82,y:48,radius:6}]),
  },
  {
    id: "minhwa04",
    title: "화조도",
    ...
    differences: fiveDifferences([{x:58,y:37,radius:7},{x:38,y:57,radius:7},{x:37,y:23,radius:6},{x:78,y:35,radius:6},{x:23,y:74,radius:7},{x:63,y:90,radius:7},{x:69,y:61,radius:6}]),
  },
  {
    id: "minhwa05",
    title: "초충도 - 가지와 방아깨비",
    ...
    differences: fiveDifferences([{x:54,y:51,radius:8},{x:75,y:25,radius:7},{x:42,y:18,radius:7},{x:66,y:64,radius:6},{x:27,y:55,radius:6},{x:79,y:72,radius:6},{x:49,y:84,radius:6}]),
  },
  {
    id: "minhwa06",
    title: "연화어해도",
    ...
    differences: fiveDifferences([{x:28,y:70,radius:8},{x:67,y:73,radius:8},{x:77,y:21,radius:7},{x:39,y:34,radius:7},{x:18,y:85,radius:6},{x:57,y:63,radius:6},{x:87,y:94,radius:6}]),
  },
  {
    id: "minhwa07",
    title: "연화도",
    ...
    differences: fiveDifferences([{x:43,y:50,radius:8},{x:47,y:30,radius:7},{x:37,y:15,radius:8},{x:44,y:75,radius:7},{x:26,y:88,radius:6},{x:18,y:82,radius:6},{x:59,y:66,radius:6}]),
  },
  {
    id: "minhwa08",
    title: "기명절지도",
    ...
    differences: fiveDifferences([{x:52,y:46,radius:8},{x:47,y:72,radius:8},{x:30,y:16,radius:7},{x:68,y:29,radius:6},{x:51,y:58,radius:6},{x:74,y:88,radius:7},{x:18,y:78,radius:7}]),
  },
  {
    id: "minhwa09",
    title: "화조도 - 모란과 새",
    ...
    differences: fiveDifferences([{x:47,y:55,radius:8},{x:61,y:56,radius:8},{x:42,y:27,radius:8},{x:68,y:31,radius:7},{x:77,y:77,radius:7},{x:51,y:88,radius:7},{x:20,y:52,radius:7}]),
  },
  {
    id: "minhwa10",
    title: "어해도",
    ...
    differences: fiveDifferences([{x:49,y:66,radius:8},{x:55,y:88,radius:8},{x:55,y:8,radius:7},{x:37,y:43,radius:7},{x:70,y:36,radius:6},{x:25,y:27,radius:6},{x:80,y:73,radius:6}]),
  },
];
