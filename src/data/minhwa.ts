...
export const minhwaList: Minhwa[] = [
  ...
  },
  {
    ...
    differenceImage: "/minhwa/minhwa02-difference-v8.png",
  ...
  },
  {
    ...
    differences: fiveDifferences([{x:63,y:15,radius:8},{x:70,y:42,radius:8},{x:58,y:39,radius:8},{x:86,y:67,radius:8},{x:60,y:69,radius:8}]),
  },
  {
    id: "minhwa05",
    title: "초충도 - 가지와 방아깨비",
    ...
    differences: fiveDifferences([{x:86,y:22,radius:7},{x:70,y:55,radius:8},{x:53,y:66,radius:8},{x:29,y:55,radius:8},{x:22,y:81,radius:8}]),
  },
  {
    id: "minhwa06",
    title: "연화어해도",
    ...
    differences: fiveDifferences([{x:55,y:16,radius:8},{x:35,y:61,radius:8},{x:67,y:65,radius:7},{x:69,y:90,radius:8},{x:86,y:94,radius:7}]),
  },
  {
    id: "minhwa07",
    title: "연화도",
    ...
    differences: fiveDifferences([{x:29,y:20,radius:8},{x:40,y:35,radius:8},{x:56,y:55,radius:9},{x:15,y:61,radius:8},{x:34,y:78,radius:8}]),
  },
  {
    id: "minhwa08",
    title: "기명절지도",
    ...
    differences: fiveDifferences([{x:45,y:50,radius:8},{x:65,y:50,radius:8},{x:52,y:66,radius:8},{x:57,y:74,radius:8},{x:38,y:84,radius:9}]),
  },
  {
    id: "minhwa09",
    title: "화조도 - 모란과 새",
    ...
    differences: fiveDifferences([{x:78,y:41,radius:9},{x:77,y:57,radius:9},{x:31,y:66,radius:8},{x:66,y:69,radius:8},{x:82,y:67,radius:8}]),
  },
  {
    id: "minhwa10",
    title: "어해도",
