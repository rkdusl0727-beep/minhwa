...
export const minhwaList: Minhwa[] = [
  {
    ...
    differences: fiveDifferences([{x:15,y:11,radius:7},{x:65,y:18,radius:7},{x:28,y:42,radius:8},{x:94,y:45,radius:7},{x:56,y:91,radius:8}]),
  },
  {
    id: "minhwa02",
    title: "호작도",
    originalImage: "/minhwa/minhwa02-original.jpg",
    differenceImage: "/minhwa/minhwa02-difference-v6.png",
    ...
    differences: fiveDifferences([{x:78,y:38,radius:8},{x:63,y:9,radius:8},{x:80,y:76,radius:9},{x:22,y:10,radius:8},{x:60,y:67,radius:8}]),
  },
  {
    id: "minhwa03",
    title: "범과 모란",
    ...
    differences: fiveDifferences([{x:12,y:28,radius:7},{x:56,y:39,radius:8},{x:67,y:35,radius:7},{x:78,y:79,radius:8},{x:86,y:7,radius:7}]),
  },
  {
    id: "minhwa04",
    title: "화조도",
    originalImage: "/minhwa/minhwa04-original.jpg",
    differenceImage: "/minhwa/minhwa04-difference-v5.webp",
    ...
    differences: fiveDifferences([{x:63,y:13,radius:8},{x:43,y:13,radius:8},{x:57,y:39,radius:8},{x:82,y:66,radius:8},{x:61,y:72,radius:8}]),
  },
  {
    id: "minhwa05",
    title: "초충도 - 가지와 방아깨비",
    originalImage: "/minhwa/minhwa05-original.jpg",
    differenceImage: "/minhwa/minhwa05-difference-v5.webp",
    ...
    differences: fiveDifferences([{x:86,y:23,radius:7},{x:77,y:52,radius:8},{x:55,y:63,radius:8},{x:28,y:51,radius:8},{x:40,y:68,radius:8}]),
  },
  {
    id: "minhwa06",
    title: "연화어해도",
    originalImage: "/minhwa/minhwa06-original.jpg",
    differenceImage: "/minhwa/minhwa06-difference-v5.webp",
    ...
    differences: fiveDifferences([{x:56,y:16,radius:8},{x:34,y:61,radius:8},{x:70,y:65,radius:7},{x:70,y:89,radius:8},{x:91,y:91,radius:7}]),
  },
  {
    id: "minhwa07",
    title: "연화도",
    originalImage: "/minhwa/minhwa07-original.jpg",
    differenceImage: "/minhwa/minhwa07-difference-v5.webp",
    ...
    differences: fiveDifferences([{x:34,y:17,radius:8},{x:44,y:34,radius:8},{x:50,y:55,radius:9},{x:28,y:79,radius:8},{x:41,y:80,radius:8}]),
  },
  {
    id: "minhwa08",
    title: "기명절지도",
    originalImage: "/minhwa/minhwa08-original.jpg",
    differenceImage: "/minhwa/minhwa08-difference-v5.webp",
    ...
    differences: fiveDifferences([{x:45,y:49,radius:8},{x:63,y:50,radius:8},{x:50,y:63,radius:8},{x:57,y:72,radius:8},{x:42,y:83,radius:9}]),
  },
  {
    id: "minhwa09",
    title: "화조도 - 모란과 새",
    originalImage: "/minhwa/minhwa09-original.jpg",
    differenceImage: "/minhwa/minhwa09-difference-v5.webp",
    ...
    differences: fiveDifferences([{x:75,y:38,radius:9},{x:78,y:62,radius:9},{x:46,y:68,radius:8},{x:64,y:71,radius:8},{x:88,y:67,radius:8}]),
  },
  {
    id: "minhwa10",
    title: "어해도",
    ...
    differences: fiveDifferences([{x:48,y:16,radius:8},{x:72,y:38,radius:8},{x:22,y:50,radius:8},{x:89,y:53,radius:8},{x:80,y:68,radius:8}]),
  },
];
