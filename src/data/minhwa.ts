...
export const minhwaList: Minhwa[] = [
  {
    ...
    differences: fiveDifferences([{x:61,y:18,radius:8},{x:16,y:12,radius:9},{x:55,y:91,radius:9},{x:29,y:42,radius:8},{x:94,y:43,radius:8}]),
  },
  {
    id: "minhwa02",
    title: "호작도",
    originalImage: "/minhwa/minhwa02-original.jpg",
    differenceImage: "/minhwa/minhwa02-difference-v5.webp",
  ...
  },
  {
    ...
    differences: fiveDifferences([{x:72,y:36,radius:8},{x:13,y:21,radius:9},{x:58,y:75,radius:9},{x:56,y:37,radius:8},{x:86,y:7,radius:8}]),
  },
  {
    id: "minhwa04",
    title: "화조도",
    ...
    differences: fiveDifferences([{x:57,y:39,radius:8},{x:56,y:16,radius:9},{x:84,y:31,radius:8},{x:83,y:66,radius:8},{x:58,y:72,radius:8}]),
  },
  {
    id: "minhwa05",
    title: "초충도 - 가지와 방아깨비",
    ...
    differences: fiveDifferences([{x:54,y:58,radius:9},{x:84,y:28,radius:8},{x:72,y:54,radius:9},{x:80,y:75,radius:9},{x:28,y:70,radius:8}]),
  },
  {
    id: "minhwa06",
    title: "연화어해도",
    ...
    differences: fiveDifferences([{x:35,y:60,radius:9},{x:68,y:64,radius:8},{x:69,y:86,radius:9},{x:56,y:16,radius:9},{x:22,y:85,radius:8}]),
  },
  {
    id: "minhwa07",
    title: "연화도",
    ...
    differences: fiveDifferences([{x:35,y:17,radius:10},{x:44,y:34,radius:9},{x:30,y:79,radius:9},{x:50,y:55,radius:10},{x:43,y:43,radius:8}]),
  },
  {
    id: "minhwa08",
    title: "기명절지도",
    ...
    differences: fiveDifferences([{x:47,y:47,radius:8},{x:42,y:82,radius:9},{x:30,y:16,radius:8},{x:51,y:62,radius:9},{x:55,y:72,radius:9}]),
  },
  {
    id: "minhwa09",
    title: "화조도 - 모란과 새",
    ...
    differences: fiveDifferences([{x:42,y:61,radius:9},{x:67,y:57,radius:10},{x:74,y:65,radius:9},{x:62,y:69,radius:9},{x:75,y:34,radius:10}]),
  },
  {
    id: "minhwa10",
    title: "어해도",
    ...
    differences: fiveDifferences([{x:67,y:66,radius:9},{x:55,y:11,radius:10},{x:27,y:46,radius:9},{x:72,y:42,radius:9},{x:61,y:32,radius:10}]),
  },
];
