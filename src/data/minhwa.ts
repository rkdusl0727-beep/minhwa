...
export const minhwaList: Minhwa[] = [
  ...
  },
  {
    ...
    differenceImage: "/minhwa/minhwa04-difference-v6.png",
    ...
    differences: fiveDifferences([{x:63,y:15,radius:8},{x:70,y:43,radius:9},{x:58,y:39,radius:8},{x:86,y:67,radius:8},{x:60,y:69,radius:8}]),
  },
  {
    id: "minhwa05",
    title: "초충도 - 가지와 방아깨비",
